  ...
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex items-center justify-center gap-4 mt-10">
        <button
          onClick={prevProject}
          className="p-3 border border-gray-400 rounded-full hover:bg-gray-100"
          aria-label="Previous project"
        >
          <img src="./assets/left-arrow.png" alt="" className="w-4 dark:hidden" />
          <img src="./assets/left-arrow-dark.png" alt="" className="w-4 hidden dark:block" />
        </button>
        <button
          onClick={nextProject}
          className="p-3 border border-gray-400 rounded-full hover:bg-gray-100"
